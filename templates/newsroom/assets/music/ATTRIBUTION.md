# Nhạc nền — kho xoay (newsroom)

Nhạc nền được LUÂN PHIÊN theo tiêu đề video (build.py, hash FNV-1a). Thả thêm .mp3 vào folder là tự vào vòng xoay.
...
Nếu gỡ toàn bộ inc-*.mp3, có thể bỏ dòng ghi nguồn trong render.mjs (MUSIC_CREDIT).
